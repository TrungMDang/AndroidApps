 ...
 * Use the {@link NavTrafficFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NavTrafficFragment extends Fragment implements View.OnClickListener {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private static final String TAG = "NavTrafficFragment";
     ...
     *
     * @return A new instance of fragment NavTrafficFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NavTrafficFragment newInstance() {
        NavTrafficFragment fragment = new NavTrafficFragment();
        return fragment;
    }
    ...
    public void onAttach(Context context) {
        Log.d(TAG, "onAttach() - Attaching to " + context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.nav_traffic_frag, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TextView tv1 = getActivity().findViewById(R.id.main_traffic_tv1);
        TextView tv2 = getActivity().findViewById(R.id.main_traffic_tv2);
        Button b = getActivity().findViewById(R.id.main_traffic_b);
...
//        //Get data
//        TextView tv2 = getActivity().findViewById(R.id.main_traffic_tv2);
//        tv2.setText(savedInstanceState.getString(KEY_DATA));
//
//        TextView tv1 = getActivity().findViewById(R.id.main_traffic_tv1);
//
//        //Put data to instance var
//        Log.d(TAG, "Stored data: " + tv2.getText() + (tv1.getText() == null ? EMPTY_STRING : tv1.getText().toString()));
//        mData.putString(KEY_DATA, tv2.getText() + " " + (tv1.getText() == null ? EMPTY_STRING : tv1.getText().toString()));
