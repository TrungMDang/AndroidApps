 ...
 * Use the {@link NavDrinkFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NavDrinkFragment extends Fragment implements View.OnClickListener {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "NavDrinkFragment";
     ...
     *
     * @return A new instance of fragment NavDrinkFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NavDrinkFragment newInstance() {
        Log.d(TAG, "New instance of Third Fragment created");
        NavDrinkFragment fragment = new NavDrinkFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.nav_drink_frag, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TextView tv1 = getActivity().findViewById(R.id.main_drink_tv1);
        TextView tv2 = getActivity().findViewById(R.id.main_drink_tv2);
        Button b = getActivity().findViewById(R.id.main_drink_b);
    ...
    public void onClick(View v) {
        Log.d(TAG, "Button was clicked. Calling interface...");
